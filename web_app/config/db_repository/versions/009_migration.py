...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['user'].columns['user_created'].drop()
    post_meta.tables['user'].columns['last_updated'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['user'].columns['user_created'].create()
    post_meta.tables['user'].columns['last_updated'].drop()
