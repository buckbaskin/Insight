//source => http://www.nr.com/webnotes/nr3web2.pdf

void SVD::decompose() { svd.h
	// Given the matrix A stored in u[0..m-1][0..n-1], this routine computes its singular value
	// decomposition, A D U  W  V_transpose and stores the results in the matrices u and v, and the vector w.
	bool flag;
	// indicies i , j , jj, k , l
	// n,m are the dimensions of the matrix
	Int i,its,j,jj,k,l,n,m;
